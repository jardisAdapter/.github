...
> These packages are MIT-licensed building blocks of the open-source foundation that Jardis-generated DDD code runs on. The platform that generates hexagonal DDD code for PHP is available at [jardis.io](https://jardis.io).
